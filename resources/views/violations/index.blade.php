    ...
    <div class="flex-1 flex flex-col bg-white">
        ...
        <header
            ...
            <nav class="flex items-center gap-10 text-lg font-semibold tracking-tight">
                ...
                <a href="{{ route('violation.monitoring') }}"
                    class="stat-btn-gradient text-white px-6 py-2 rounded-full shadow-inner">VIOLATION MONITORING</a>
                <a href="#" class="hover:text-red-200 transition">REPORT</a>
            </nav>
            <div class="flex items-center gap-6">
                <!-- Notification Bell -->
                <svg class="w-8 h-8 cursor-pointer hover:text-red-200 transition" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                ...
                <!-- Profile Dropdown -->
                <div
                    class="flex items-center gap-3 bg-white text-grc-red px-4 py-1 rounded-full font-bold cursor-pointer shadow-md hover:bg-gray-100 transition">
        ...
        <main class="flex-1 grc-red p-8 flex flex-col overflow-y-auto">
            ...
            <div class="flex justify-center gap-12 text-white font-bold text-base mb-8">
                <div class="cursor-pointer pb-1 transition-all border-b-2 border-transparent" id="tab-0"
                    onclick="switchTab(0)">ACTIVE CASE</div>
                <div class="cursor-pointer pb-1 transition-all border-b-2 border-transparent" id="tab-1"
                    onclick="switchTab(1)">RESOLVED CASE</div>
                <div class="cursor-pointer pb-1 transition-all border-b-2 border-transparent" id="tab-2"
                    onclick="switchTab(2)">TOTAL VIOLATION</div>
                <div class="cursor-pointer pb-1 transition-all border-b-2 border-transparent" id="tab-3"
                    onclick="switchTab(3)">PENDING</div>
            </div>
